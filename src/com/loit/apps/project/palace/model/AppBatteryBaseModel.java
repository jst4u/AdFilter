...
/**
 * Model class for AppBatteryBase
 */
@Entity
@Table(name = "app_battery_base")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class AppBatteryBaseModel extends BaseModel {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "AppBatteryBase";
	...
	public void setBatteryState(String batteryState) {
		...
		addValidField(FieldNames.batteryState);
	}
