...
/**
 * Model class for AppNodeBase
 */
@Entity
@Table(name = "app_node_base")
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
public class AppNodeBaseModel extends BaseModel {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "AppNodeBase";
	...
	public void setNodeState(String nodeState) {
		...
		addValidField(FieldNames.nodeState);
	}
