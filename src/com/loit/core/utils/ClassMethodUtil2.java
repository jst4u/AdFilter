...
public class ClassMethodUtil2 {

	/**
	 * * 获取Method的形参名称列表 * @param method 需要解析的方法 * @return
	...
	/**
	 * * 获取Constructor的形参名称列表 * @param constructor 需要解析的构造函数 * @return
	 * 形参名称列表,如果没有调试信息,将返回null
	 */
	...
	/**
	 * * 获取一个类的所有方法/构造方法的形参名称Map * @param klass 需要解析的类 * @return
	 * 所有方法/构造方法的形参名称Map * @throws IOException
	...
	public static Map<String, List<String>> getParamNames(InputStream in) throws IOException {
		...
		for (int i = 0; i < (constant_pool_count - 1); i++) {
			...
			case 7: // CONSTANT_Class:
				dis.skipBytes(2);
				break;
			case 9: // CONSTANT_Fieldref: case
			case 10:// CONSTANT_Methodref: case
			...
			case 6: // CONSTANT_Double:
				...
				break;
			case 12:// CONSTANT_NameAndType: dis.skipBytes(2);
				dis.skipBytes(2);
				break;
