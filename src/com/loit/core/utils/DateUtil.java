...
public class DateUtil {
	...
	public static String format(Date date) {
		String a;
		if ((a = formatDateTime(date)).endsWith(" 00:00:00")) {
			a = a.substring(0, 10);
		}
		return a;
	}
	...
	// /**
	// *
	// * 将字符串按指定格式转换为java.util.Date类型，format的取值在类中定义了常量，默认格式为yyyy-MM-dd
	// HH:mm:ss
	// *
	// * @param str
	// * 待转化的字符串
	...
	// return ((theYear % 4 == 0 && theYear % 100 != 0) || (theYear % 400 ==
	// 0));
	// }
	//
	// /**
	...
	// Calendar caldTmp = Calendar.getInstance();
	// // 注意：月份的起始值为０而不是１，所以要设置八月时，我们用７而不是8 -> calendar.set(Calendar.MONTH,
	// 7);
	// caldTmp.set(getIntYearOfDate(strYYYYMMDD),
	...
	// *
	// */
	// public static String getMondayOfWeek(String strYYYYMMDD, int
	// weekIndex) {
	// int nYear = 0;
	// int nMonth = 0;
	// int nDay = 0;
	...
	// // 上月最后一天的sunday
	// String strSundayOfLastWeekOfPreMonth =
	// getSundayOfThisWeek(strLastDateOfPreMonth);
	...
	// Date dSundayOfLastWeekOfPreMonth =
	// string2Date(strSundayOfLastWeekOfPreMonth);
	// nDateDiffNoTime = dateDiffNoTime(dParam,
	...
	// // 判断该月一号是否为周日？
	// // 本月1号对应的sunday
	// String strSundayOfFirstDayOfThisMonth =
	// getSundayOfThisWeek(strFirstDayOfThisMonth);
	...
	// //System.out.println(DateUtil.getCurrentData());
	// //System.out.println(DateUtil.getCurrentDataTime());
	//
	// //System.out.println(DateUtil.addSecond(new Date(),( 50*3600)));
	//
	// System.out.println(dateDiff("n",DateUtil.string2Date("2010-10-09 11:48",
	// DateUtil.YYYY_MM_DD_HH_MM),new Date()));
	//
	// }
	// /**
	// * 刘正
