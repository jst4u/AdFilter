...
<div id="${gridId}" class="grid_panel">
		<div id="grid_thead" class="grid_head">
	        <table cellspacing="0" bgcolor="#6894C5"  cellpadding="0">
					...
					<#list fields as field>
						<td name="title_td" style="border-right:#cbcbcb 1px solid">
							<div style="cursor:hand;position:relative;width:100%;overflow:hidden">
								<span name="label_bar" style="margin-left:5px;width:100%">${field.label}</span>
								<span name="resizebar" style="cursor:col-resize;width:5px;height:100%;position:absolute;right:0px;"></span>
							</div>
						</td>
					</#list>
	        		<!--表头最后一列加宽，解决滚动条拖到最右边不对齐问题-->
	        		<td><span style="width:1000px;"></span></td>
	        		</tr>
	        </table>
    	</div>

        
        <div id="grid_tbody" class="grid_body">
