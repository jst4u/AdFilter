		...
		<loit:layout fit="true">
			...
			<loit:layoutEast split="false" style="width: 300px;">
				<loit:panel title="角色权限" style="padding: 0px; " fit="true" border="false" iconCls="tree-file">
					<loit:panel title="角色的用户" style="padding: 0px; overflow-y:hidden;" border="false" iconCls="tree-file" tools="#userButton">
		...
		<div style="text-align: center;">
			<loit:form id="editformSysRole" method="post" type="ft">
				...
				<tr>
					...
					<%-- <loit:thd label="创建者:" tagType="validatebox" name="creator" required="false"></loit:thd>
							</tr>
							<tr>
							<loit:thd label="创建时间:" tagType="validatebox" name="createTime" required="false"></loit:thd>
						
							<loit:thd label="修改者:" tagType="validatebox" name="modifier" required="false"></loit:thd>
							</tr>
							<tr>
							<loit:thd label="修改时间:" tagType="validatebox" name="modifyTime" required="false"></loit:thd>
							<loit:thd label="recVer:" tagType="validatebox" name="recVer" required="false"></loit:thd> --%>
				</tr>
				<tr>
	...
	<loit:window id="editWindowSysUserRole" title="Modal Window" modal="true" closed="true" style="width: 300px; padding: 10px;">
		<div style="text-align: center;">
			<loit:form id="editformSysUserRole" method="post" type="ft">
				...
				<tr>
					<loit:thd label="用户:" tagType="combobox" name="userId" codeType="user" valueField="id" panelHeight="auto" required="true"></loit:thd>
				</tr>
				<tr>
					<loit:thd label="角色:" tagType="combobox" name="roleId" codeType="role" valueField="id" panelHeight="auto" required="true"></loit:thd>
				</tr>
				<tr>
				...
				<tr>
					...
					<%-- <loit:thd label="创建人:" tagType="validatebox" name="creator" required="false"></loit:thd>
							</tr>
							<tr>
							<loit:thd label="创建时间:" tagType="validatebox" name="createTime" required="false"></loit:thd>
							<loit:thd label="修改者:" tagType="validatebox" name="modifier" required="false"></loit:thd>
							...
							<tr>
							<loit:thd label="修改时间:" tagType="validatebox" name="modifyTime" required="false"></loit:thd>
							<loit:thd label="版本:" tagType="validatebox" name="recVer" required="false"></loit:thd> --%>
				</tr>
				<tr>
					<loit:thd tcolspan="4" tstyle="text-align: center">
...
<script language="javascript">
	...
	function to_del() {
		...
		$.messager.confirm("确认信息", "确定删除数据行？", function(res) {
			if (res) {
				$.messager.progress();
				sysRoleManager.removeByPk(row.roleId, function(data) {
					$.messager.progress("close");
	...
	function save_func() {
		var func = $("#funcTree").tree('getChecked');
		var role = $('#dgSysRole').datagrid("getSelected");
		var data;
		if (!role) {
		...
		if (''==func) {
			$.messager.alert('提示信息', '请选择要修改的功能！', 'info');
		}
		for ( var i = 0; i < func.length; i++) {
			var roleId = role.roleId;
			var funcId = func[i].id;
			data = {
				"roleId" : roleId,
				"funcId" : funcId
			};
	...
	function query_func() {
		...
		var roles = $('#dgSysRole').datagrid("getSelected");
		var idValue = roles.roleId;
		sysRoleFuncManager.getAll(function(data) {
			for ( var i = 0; i < data.length - 1; i++) {
				if (idValue == data[i].roleId) {
					var d1 = data[i].funcId;
					var node = $('#funcTree').tree('find', d1);
