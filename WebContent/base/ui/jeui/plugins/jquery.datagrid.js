...
(function($) {
	...
	function _6e(_6f) {
		...
		_74.unbind(".datagrid").bind("click.datagrid", function(e) {
			...
			if (e.pageX < p2 && e.pageX > p1) {
				...
				function(e) {
					var p1 = $(this).offset().left + 5;
					var p2 = $(this).offset().left + $(this)._outerWidth() - 5;
					var _78 = _72.resizeHandle == "right" ? (e.pageX > p2)
							: (_72.resizeHandle == "left" ? (e.pageX < p1)
		...
		var _7a = _72.resizeHandle == "right" ? "e"
							...
							.resizable(
									{
										...
										onStopResize : function(e) {
											...
											_87(_6f);
											_72.onResizeColumn.call(_6f, _7b,
													col.width);
											setTimeout(function() {
												_70.resizing = false;
											}, 0);
	...
	function _95(_96, _97) {
		...
		function _19(_9b) {
			...
			function _9e(_9f) {
				var _a0 = 0;
				_98.finder.getTr(_96, 0, _9f).find(
						"td[field=\"" + _9b + "\"] div.datagrid-cell").each(
						function() {
			...
			if (_c0.idField) {
				for ( var i = 0; i < _be.rows.length; i++) {
					...
					if (_c4(_bf.selectedRows, row)) {
						_c0.finder.getTr(_bd, i).addClass(
								"datagrid-row-selected");
					}
					if (_c4(_bf.checkedRows, row)) {
						_c0.finder.getTr(_bd, i).find(
	...
	function _de(_df, _e0) {
		...
		var _e2 = _e1.options;
		_e2.finder.getTr(_df, _e1.highlightIndex).removeClass(
				"datagrid-row-over");
	...
	function _ea(_fd, _fe) {
		...
		opts.finder.getTr(_fd, "", "selected").removeClass(
				"datagrid-row-selected");
		if (opts.idField) {
	...
	function _eb(_103, _104, _105) {
		...
		var ck = opts.finder.getTr(_103, _104).find(
				"div.datagrid-cell-check input[type=checkbox]");
	...
	function _f3(_108, _109, _10a) {
		...
		var ck = opts.finder.getTr(_108, _109).find(
				"div.datagrid-cell-check input[type=checkbox]");
	...
	function _fb(_10d, _10e) {
		...
		var bck = opts.finder.getTr(_10d, "", "allbody").find(
				"div.datagrid-cell-check input[type=checkbox]");
	...
	function _101(_110, _111) {
		...
		var dc = _112.dc;
		var hck = dc.header1.add(dc.header2).find("input[type=checkbox]");
		var bck = opts.finder.getTr(_110, "", "allbody").find(
				"div.datagrid-cell-check input[type=checkbox]");
	...
	function _166(_167, _168) {
		...
		var tr = opts.finder.getTr(_167, (_168.index != undefined ? _168.index
				: _168.id));
		if (!tr.length) {
			return;
		}
	...
	$.fn.datagrid.methods = {
		...
		updateRow : function(jq, _1d2) {
			return jq
					.each(function() {
						var opts = $.data(this, "datagrid").options;
						opts.view.updateRow.call(opts.view, this, _1d2.index,
								_1d2.row);
					});
		},
	...
	$.fn.datagrid.parseOptions = function(_1db) {
		...
		return $.extend({}, $.fn.panel.parseOptions(_1db), $.parser
				.parseOptions(_1db, [ "url", "toolbar", "idField", "sortName",
	...
	$.fn.datagrid.parseData = function(_1dc) {
		...
		var _1dd = t.datagrid("getColumnFields", true).concat(
	...
	var _1de = {
		...
		onAfterRender : function(_214) {
			...
			if (opts.showFooter) {
				var _215 = $(_214).datagrid("getPanel").find(
						"div.datagrid-footer");
				_215
						.find(
					...
					$.fn.panel.defaults,
					{
						...
						finder : {
							getTr : function(_21b, _21c, type, _21d) {
								...
								if (_21d == 0) {
									var tr1 = opts.finder.getTr(_21b, _21c,
											type, 1);
									var tr2 = opts.finder.getTr(_21b, _21c,
											type, 2);
									return tr1.add(tr2);
								} else {
									if (type == "body") {
										var tr = $("#" + _21e.rowIdPrefix + "-"
												+ _21d + "-" + _21c);
										if (!tr.length) {
											tr = (_21d == 1 ? dc.body1
													: dc.body2)
										...
										if (type == "footer") {
											return (_21d == 1 ? dc.footer1
													: dc.footer2)
													.find(">table>tbody>tr[datagrid-row-index="
															+ _21c + "]");
										} else {
											if (type == "selected") {
												return (_21d == 1 ? dc.body1
														: dc.body2)
