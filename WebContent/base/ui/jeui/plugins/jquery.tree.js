...
(function($) {
				...
				.droppable(
						{
							...
							onDrop : function(e, _27) {
								...
								if (_1b.onBeforeDrop.call(_19, _28, _bb(_19,
										_27), _2a) == false) {
									$(this)
											.removeClass(
													"tree-node-append tree-node-top tree-node-bottom");
		...
		function _59(ul, _5c, _5d) {
			for ( var i = 0; i < _5c.length; i++) {
				...
				$("<span class=\"tree-title\"></span>").html(
						_56.formatter.call(_53, _5e)).appendTo(_5f);
				if (_56.checkbox) {
	...
	function _14(_c9, _ca) {
		...
		if (!_4d(_c9, _ca)) {
			_cb.state = $(_ca).find(".tree-hit").hasClass("tree-expanded") ? "open"
					: "closed";
		}
		return _cb;
	}
	...
	$.fn.tree.methods = {
		options : function(jq) {
			var opt = $.data(jq[0], "tree").options;
			return opt;
		},
