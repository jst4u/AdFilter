...
(function ($) {
	...
	//	 + '.calendar-hover{border: 1px solid red;}.fullcalendar-body th{padding: 5px;height:10px;}'
	//	 + '.fullcalendar-detail{border-radius:5px;position: absolute; z-index: 10; background-color: rgb(0, 0, 102); display: none; opacity: 0.8; padding: 5px; text-align: right;filter: Alpha(opacity=80);width:120px;}'
	//	 + '.fullcalendar-detail div{background:#CCFFCC;margin-top: 3px;font-size: 10px;padding: 2px;}'
